                                ...
                                <form method="post" id="add_sub_activity" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="activity_arabic_name" placeholder="Enter Arabic Name" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="email">English Name</label>
                                            <input type="text" name="activity_english_name" placeholder="Enter English Name" class="form-control" required>
                                        </div>
                                        <div class="form-group">
