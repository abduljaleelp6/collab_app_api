            ...
            <div class="content">
                <div class="container">
                    ...
                    <a href="/dashboard/home" class="btn btn-sm btn-outline-danger"><i class="fas fa-home"></i>Home</a>
                        <h3>Category List
                            <a href="#" class="btn btn-sm btn-outline-primary float-right"><i class="fas fa-user-shield"></i> Add Category</a>
                        </h3>
                    </div>
...
$( document ).ready(function() {
    $.ajax({
          type:'GET',
          url: '/category/getMainCategoriesWithSubCount',
		  //dataType: 'json',
           ...
           success: (response) => {
            ...
            '<td style="width:20%">'+val.category_identifier+'</td>'+
                        ...
                        '<td style="width:15%">'+val.category_description+'</td>'+
