...
<body>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                 ...
                                 <form method="post" id="add_group_member" enctype="multipart/form-data">
                                    @csrf
                                         <div class="form-group">
                                           
                                            <div class="form-group">
                                            <label>Group Name</label>
                                            <select class="form-control select2" id="gp_list" name="gp_list">
    ...
    function get_group_list(formData)
            {
          
              
            $.ajax({
            type:'POST',
            url: '/chat/get_Group_List',
		    dataType: 'json',
            data: formData,
            contentType: false,
            processData: false,
            success: (response) => {
               // alert(JSON.stringify(response));
                ...
                $.each(response.data, function (key, val) 
                {
                        ...
                        $("#gp_list").append("<option value="+val.gid+">"+val.gname+"</option>");
    ...
    $('#add_group_member').submit(function(e) 
    {
       e.preventDefault();
