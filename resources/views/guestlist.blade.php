...
function get_data(formData)
{
    $.ajax({
          type:'POST',
          url: '/questuser/get_all_guest_users',
          ...
          dataType: 'json',
           ...
           success: (response) => {
            ...
            $("#business_table").html('<thead><tr><th>Name</th><th>Email</th><th>Phone</th>'+
            '<th>OTP</th></tr></thead>');
            ...
            var class_val=scolor[val.guest_status];
            var status=slabel[val.guest_status];
           ...
           // class_val="btn btn-outline-success";
			...
			$("#business_table").append('<tr>'+
                        ...
                        '<td style="width:20%">'+val.guest_name+'</td>'+
                        '<td style="width:20%">'+val.guest_email+'</td>'+
                        '<td style="width:20%">'+val.guest_phone+'</td>'+
                        '<td style="width:10%" ><b><span class="btn-rounded" style="color:red;">'+val.guest_otp+'</span></b></td>'+
