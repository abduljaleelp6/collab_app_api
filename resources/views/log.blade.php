                ...
                <div class="card-body text-center">
                    ...
                    @csrf
                        <div class="form-group text-left">
                            ...
                            <input type="email" class="form-control" placeholder="Enter Username" id="user" required>
                        </div>
                        <div class="form-group text-left">
                        ...
                        <button type="button" class="btn btn-lg btn-block" style="background-color:#6c9ecf;" id="btn-login"><b><span style="color:white;font-size:15px;">Login</span></b></button>
