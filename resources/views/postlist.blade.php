...
function get_data(formData)
{
    $.ajax({
          type:'POST',
          url: '/post/getAllPostWithReportCount',
          ...
          dataType: 'json',
           ...
           success: (response) => {
            ...
            '<th>Category</th><th>Reported</th><th>Status</th><th></th></tr></thead>');  
           ...
           // class_val="btn btn-outline-success";
            ...
            '<td style="width:10%"><a href="/post/post_single/'+val.p_id+'" target="_blank"><img width="70px" height="50px;" src="/'+val.post_image+'"></a></td>'+
                        '<td style="width:20%">'+val.business_name+'</td>'+
                        '<td style="width:20%"><textarea style="width:100%;" disabled>'+val.post_text+'</textarea></td>'+
                        '<td style="width:20%">'+val.category_name+'</td>'+
                        '<td style="width:10%" ><b><span class="btn-rounded" style="color:red;">'+rcount+'</span></b></td>'+
